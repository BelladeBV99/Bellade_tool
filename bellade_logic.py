...
def bereken_rendement(data: Dict[str, float]) -> Dict:
    ...
    rendement_jaarlijks = round(grafiek_data[-1] / (opstartkost + (huurprijs * 60)) / 12 * 100, 2)
    ...
    return {
        ...
        'omzet': round((sessies_rij_46[0] * dagen_per_maand * verbruik_per_sessie * kwhprijs) +
                       (starttarief + parkeertarief) * sessies_rij_46[0] * dagen_per_maand, 2),
        ...
        'rendement_jaarlijks': rendement_jaarlijks
    }
